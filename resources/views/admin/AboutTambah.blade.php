            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title" style="margin-bottom: 1px;">Tambah Wisata</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('abouts.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="nama" placeholder="Nama Tempat Wisata" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="id_genre">
                                            ...
                                            <option value="{{$genre->id}}">{{$genre->id}}-{{$genre->nama}}</option>
                                            @endforeach     
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea style="height: 250px;" class="form-control" name="penjelasan" placeholder="Deskripsi" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="alamat" id="searchmap" placeholder="Masukkan Lokasi" required>  
